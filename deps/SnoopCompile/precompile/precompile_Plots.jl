...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(gr_label_ticks),Subplot{GRBackend},Symbol,Tuple{Array{Float64,1},Array{Any,1}}})
    ...
    Base.precompile(Tuple{typeof(is_marker_supported),PlotlyBackend,Array{Symbol,1}})
