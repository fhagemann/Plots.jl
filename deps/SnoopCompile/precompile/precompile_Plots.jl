...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(RecipesBase.apply_recipe),Dict{Symbol,Any},Type{Val{:heatmap}},Plot{GRBackend}})
    ...
    Base.precompile(Tuple{typeof(gr_draw_marker),Series,Float64,Float64,Tuple{Float64,Float64},Int64,Int64,Int64,Shape})
    ...
    isdefined(Plots, Symbol("#145#146")) && Base.precompile(Tuple{getfield(Plots, Symbol("#145#146")),Tuple{Int64,Expr}})
